...
from blackhole.embadding_hugging_face import BlackholeEmbeddings
...
def test_embedding_layer(tokenizer, num_token_id, freeze_heavy_features=False):
    ...
    bh_config = BlackholeConfig(
        ...
        numeric_heavy_feature_freeze=freeze_heavy_features, # This is correctly passed here
    )
...
def test_blackhole_model(tokenizer, config):
    ...
    model = BlackholeModel(config) # config now has numeric_heavy_feature_freeze
...
def test_masked_lm_model(tokenizer, config):
    ...
    mlm_config = BlackholeConfig(
        ...
        numeric_heavy_feature_freeze=config.numeric_heavy_feature_freeze, # Ensure this is passed
    )
...
if __name__ == "__main__":
    ...
    base_config = BlackholeConfig(
        ...
        numeric_heavy_feature_freeze=False, # ADDED: Ensure base_config has this attribute
    )
